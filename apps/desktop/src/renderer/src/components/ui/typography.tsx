...
/**
 * Typography primitives derived from the shadcn/ui typography docs.
 * The shadcn CLI doesn't install these — the docs page shows the styles and
 * suggests copy-pasting into your project. They live here so feature screens
 * can reach for a consistent `<H1>` / `<P>` / `<Muted>` without re-deriving
 * the class lists every time.
 */
